...
const designTokens = {
  light: {
    ...
    "shadow-cf":
      "0 2px 8px rgba(16, 32, 28, 0.06), 0 1px 2px rgba(16, 32, 28, 0.04)",
    "shadow-lg-cf":
      "0 12px 32px -8px rgba(16, 32, 28, 0.14), 0 4px 12px rgba(16, 32, 28, 0.06)",
  },
  dark: {
    background: "165 25% 7%",
    "outer-bg": "165 22% 4%",
...
const generateCssVariables = plugin(function ({ addBase }) {
  ...
  addBase({
    ...
    "#root": {
      ...
      "box-shadow":
        "0 0 0 1px hsl(var(--border) / 0.6), 0 8px 48px rgba(0, 0, 0, 0.14)",
    },
  });
});
